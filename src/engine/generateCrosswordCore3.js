 ...
 * Uses layoutGeneratorCore3 (fixed 13×13). Target: 32–40 words, 30–35% black.
 */

import { generateLayout } from './layoutGeneratorCore3.js'
...
export function generateCrosswordCore3(wordList) {
